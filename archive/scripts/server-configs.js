...
window.serverConfigs = {
  "baldapes-lab": {
    ...
    description:
      "Flagship server with premium organization, active community engagement, and professional Discord management.",
  },
  "panda-picks": {
  ...
  cantstopthecaptv: {
    ...
    description:
      "Entertainment-focused betting community with custom features.",
  },
  betsbyraven: {
